...
?><br><br>
 ...
 <div class="team py-5" id="team">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="w3ls-title text-da text-center font-weight-bold mb-5 pb-xl-4">Our <span class="font-weight-light">Gallery</span></h3>
                  ...
                  foreach($category_type as $rows)
                     {
                        ?>
                        <?php
			foreach ($fetch as $rowz) 
			
			?>
				<div class="col-lg-2 col-sm-6 team-grid">
					<a href="<?php echo base_url('index.php/Usercontroller/user_plantseed_nsry/'.$rows->category_type_id.'/'.$rowz->ps_nursery_id)?>">
					<img src="<?php echo base_url('Asset/nursery/category_type/'.$rows->c_type_image)?>" class="img-fluid" alt="" style="border-radius: 50%;height: 150px;width: 150px">
				</a>
					<div class="caption">
						<div class="team-text">
							<h4 style="font-size: 15px"><?php echo $rows->category_type_name?></h4>
			...
			?>
				<div class="col-md-3 gal-grid-wthree">
					<div class="gallery-demo">
						<a href="<?php echo base_url('index.php/Usercontroller/user_plantseed_single/'.$rows->ps_id)?>">
