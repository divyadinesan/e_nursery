		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row team-bottom pt-4 text-center">
				...
				<div class="col-lg-2 col-sm-6 team-grid">
					<a href="<?php echo base_url('index.php/Usercontroller/user_plantseed/'.$rows->category_type_id.'/'.$rows->catgry_id)?>">
					<img src="<?php echo base_url('Asset/nursery/category_type/'.$rows->c_type_image)?>" class="img-fluid" alt="" style="border-radius: 50%;height: 150px;width: 200px">
				</a>
					<div class="caption">
						<div class="team-text">
