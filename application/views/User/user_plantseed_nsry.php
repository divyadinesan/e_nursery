		...
		<div class="container py-xl-5 py-lg-3">
			...
			?>
				...
				<div class="col-lg-2 col-sm-6 team-grid" >
					...
					<img src="<?php echo base_url('Asset/nursery/category_type/'.$rows->c_type_image)?>" class="img-fluid" alt="" style="border-radius: 50%;height: 130px;width: 140px">
				</a>
					<div class="caption">
						<div class="team-text">
