			...
			<div class="row">
				...
				<div class="col-md-4 gal-grid-wthree">
					<div class="gallery-demo">
						<a href="">
							<img src="<?php echo base_url('Asset/nursery/plantseed/'.$silfrtlzr->ps_image)?>" alt=" " class="img-fluid" / style="height: 350px;width: 450px">
						</a>
				...
				<div class="col-lg-6 about-right offset-lg-1">
					...
					<h3 class="tittle-w3layouts text-uppercase pr-lg-5 mt-2"><?php echo $silfrtlzr->ps_name?></h3><br>
					<h4>₹<?php echo $silfrtlzr->ps_price?></h4><br>
					<form method="post" action="<?php echo base_url('index.php/Usercontroller/ps_addtocart')?>">
						...
						?>
					<input type="hidden" name="category_id" value="<?php echo $silfrtlzr->catgry_id?>">
						<input type="hidden" name="userid" value="<?php echo $usr->user_id?>">
						<input type="hidden" name="useremail" value="<?php echo $usr->email?>">
						<input type="hidden" name="nurseryemail" value="<?php echo $silfrtlzr->nursery_email?>">
						<input type="hidden" name="nurseryid" value="<?php echo $silfrtlzr->ps_nursery_id?>">
						<input type="hidden" name="psid" value="<?php echo  $silfrtlzr->ps_id?>">
						<input type="hidden" name="price" value="<?php echo $silfrtlzr->ps_price?>">
		...
		<div class="py-xl-5 py-lg-3">
			<div class="row no-gutters">
				 <ul class="author list-unstyled d-flex">
						<li><img class="img-fluid rounded-circle" src="<?php echo base_url('Asset/nursery/license/'.$silfrtlzr->liecence)?>" alt="" style="height: 120px;width: 200px"></li>
						<li class="ml-4 mt-4"><span><?php echo $silfrtlzr->name?></span><h6 style="color: black"><b><i><?php echo $silfrtlzr->email?></i></b></h6><h6 style="color: 
						black"><?php echo $silfrtlzr->address?></h6></li>
					</ul>
					...
					<ul class="timeline">
						<li>
							...
							<p><?php echo $silfrtlzr->ps_description?></p>
						</li>
						<li>
							<a href="#why" class="head-text-w3"> Care</a>
							
							<p><?php echo $silfrtlzr->ps_care?></p>
						</li>
						<li>
							<a href="#why" class="head-text-w3">Use</a>
							<p><?php echo $silfrtlzr->uses?></p>
						</li>
