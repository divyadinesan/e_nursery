...
?><br><br>
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row team-bottom pt-4 text-center">
				...
				<div class="col-lg-3 col-sm-6 team-grid">
					<a href="<?php echo base_url('index.php/Usercontroller/user_soilfertilizer/'.$row->category_type_id.'/'.$row->catgry_id)?>">
					<img src="<?php echo base_url('Asset/nursery/category_type/'.$row->c_type_image)?>" class="img-fluid" alt="" style="border-radius: 50%;height: 200px;width: 200px">
				</a>
					<div class="caption">
						<div class="team-text">
							<h4><?php echo $row->category_type_name?></h4>
						</div>
						</div>
				</div>
	...
	<section class="portfolio py-5" id="gallery">
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row pt-4">
			<?php
			foreach ($soil_fertlizer as $rows) {
