...
<body>
	<!--header-->
			...
			<div class="header-top">
				<div class="container">
					...
					<ul>
						...
						<li><a href="<?php echo base_url('inswx.php/Nueserycontroller/login')?>">Login</a></li>
									...
									<li class="dropdown">
										...
										<ul class="dropdown-menu multi-column columns-3">
											<div class="row">
												...
												<div class="col-sm-3  multi-gd-img">
														<a href="products.html"><img src="<?php echo base_url('Asset/nursery/images/woo.jpg')?>" alt=" "/></a>
												</div> 
												<div class="col-sm-3  multi-gd-img">
														<a href="products.html"><img src="<?php echo base_url('Asset/nursery/images/woo1.jpg')?>" alt=" "/></a>
												</div>
												<div class="clearfix"></div>
											</div>
										</ul>
									...
									<li class="dropdown">
										...
										<ul class="dropdown-menu multi-column columns-3">
											<div class="row">
												...
												<div class="col-sm-3  multi-gd-img">
														<a href="products1.html"><img src="<?php echo base_url('Asset/nursery/images/woo3.jpg')?>" alt=" "/></a>
												</div> 
												<div class="col-sm-3  multi-gd-img">
														<a href="products1.html"><img src="<?php echo base_url('Asset/nursery/images/woo4.jpg')?>" alt=" "/></a>
												</div>
												<div class="clearfix"></div>
											</div>
										</ul>
							...
							<div class="cart box_1">
								<a href="checkout.html">
									<h3> <div class="total">
										...
										<img src="<?php echo base_url('Asset/nursery/images/bag.png')?>" alt="" />
									</h3>
								</a>
		...
		<div class="banner-w3">
					...
					<div class="core-slider_viewport">
						<div class="core-slider_list">
							<div class="core-slider_item">
								<img src="<?php echo base_url('Asset/nursery/images/b1.jpg')?>" class="img-responsive" alt="">
							</div>
							 <div class="core-slider_item">
								 <img src="<?php echo base_url('Asset/nursery/images/b2.jpg')?>" class="img-responsive" alt="">
							 </div>
							<div class="core-slider_item">
								  <img src="<?php echo base_url('Asset/nursery/images/b3.jpg')?>" class="img-responsive" alt="">
							</div>
							<div class="core-slider_item">
								  <img src="<?php echo base_url('Asset/nursery/images/b4.jpg')?>" class="img-responsive" alt="">
							</div>
						 </div>
					</div>
			...
			<link href="<?php echo base_url('Asset/nursery/css/coreSlider.css')?>" rel="stylesheet" type="text/css">
			<script src="<?php echo base_url('Asset/nursery/js/coreSlider.js')?>"></script>
			<script>
			$('#example1').coreSlider({
			  pauseOnHover: false,
			  interval: 3000,
				...
				<div class="ban-bottom-w3l">
					<div class="container">
						<div class="col-md-6 ban-bottom">
							<div class="ban-top">
								<img src="<?php echo base_url('Asset/nursery/images/p1.jpg')?>" class="img-responsive" alt=""/>
								<div class="ban-text">
						...
						<div class="col-md-6 ban-bottom3">
							<div class="ban-top">
								<img src="<?php echo base_url('Asset/nursery/images/p2.jpg')?>" class="img-responsive" alt=""/>
								<div class="ban-text1">
							...
							<div class="ban-img">
								<div class=" ban-bottom1">
									<div class="ban-top">
										<img src="<?php echo base_url('Asset/nursery/images/p3.jpg')?>" class="img-responsive" alt=""/>
										<div class="ban-text1">
											<h4>T - Shirt</h4>
										</div>
									</div>
								...
								<div class="ban-bottom2">
									<div class="ban-top">
										<img src="<?php echo base_url('Asset/nursery/images/p4.jpg')?>" class="img-responsive" alt=""/>
										<div class="ban-text1">
											<h4>Hand Bag</h4>
										</div>
									</div>
					...
					<div class="copy-section">
						<div class="container">
							...
							<div class="copy-right">
								<img src="<?php echo base_url('Asset/nursery/images/card.png')?>" alt=""/>
							</div>
							<div class="clearfix"></div>
						</div>
					</div>
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body">
							<div class="news-gr">
								...
								<img src="<?php echo base_url('Asset/nursery/images/p5.jpg')?>" class="img-responsive" alt="">
								</div>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content modal-info">
						...
						<div class="modal-body">
							<div class="news-gr">
								<div class="col-md-5 new-grid1">
								<img src="<?php echo base_url('Asset/nursery/images/p7.jpg')?>" class="img-responsive" alt="">
								</div>
									<div class="col-md-7 new-grid">
										<h5>Ten Women's Cotton Viscose fabric Grey Shrug</h5>
										<h6>Quick Overview</h6>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content modal-info">
						...
						<div class="modal-body">
							<div class="news-gr">
								<div class="col-md-5 new-grid1">
								<img src="<?php echo base_url('Asset/nursery/images/p10.jpg')?>" class="img-responsive" alt="">
								</div>
									<div class="col-md-7 new-grid">
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content modal-info">
						...
						<div class="modal-body">
							<div class="news-gr">
								<div class="col-md-5 new-grid1">
								<img src="<?php echo base_url('Asset/nursery/images/p12.jpg')?>" class="img-responsive" alt="">
								</div>
									<div class="col-md-7 new-grid">
										<h5>Ten Men's Cotton Viscose fabric Grey Shrug</h5>
										<h6>Quick Overview</h6>
